...
We recommend to use grids with a similiar size to the simulation box, as the GIST calculation will usually not be the time limiting step and a region of interest can then be chosen freely.
...
However, larger grids might be necessary for example for strongly charged solutes.
