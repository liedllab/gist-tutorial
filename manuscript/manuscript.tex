...
\begin{figure}
	...
	\includegraphics[width=\linewidth]{figures/binding-pocket-E.png}
	\caption{Green: negative energy (based on $E_{sw} + 2E_{ww}$). Red: positive energy.}
	\label{fig-binding-pocket-energy}
    \end{subfigure}
	\hfill
	\begin{subfigure}[b]{0.3\textwidth}
		\includegraphics[width=\linewidth]{figures/binding-pocket-S.png}
	...
	Isolevels shown are ($\pm$) 0.25, 0.5, 1.0, 1.5, 2.0, 2.5, and 3.0 \si{\kcal\per\mole\per\angstrom\square}, except for 
	the positive energy, where they are divided by two.}
