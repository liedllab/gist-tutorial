...
\begin{figure}
	...
	\caption{Water energy using "norm" data in the streptavidin binding pocket overlayed with biotin. Red: high solvent energy (at +3 
	kcal/mol/molecule). Green: low solvent energy (at -3 kcal/mol/molecule). The energy density is based on the apo structure and is shown only when within \qty{1.5}{\angstrom} of biotin.}\label{fig_binding_pocket_pymol}
\end{figure}
