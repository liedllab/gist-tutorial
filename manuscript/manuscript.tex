...
A .dx file can be produced using gisttools as follows:
...
\begin{figure}
	...
	\caption{Free energy contributions in the streptavidin binding pocket. Red: high solvent energy (at +3 kcal/mol). Blue: low solvent energy (at -2 kcal/mol). Green: low solvent entropy $T\Delta S^{six}$ (at -2 kcal/mol).}
...
For the streptavidin integral, we align the complex structure onto the streptavidin structure and then use the biotin positions as centers.
