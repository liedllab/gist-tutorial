...
\subsubsection{Visualization the GIST results}
Visualizing the GIST quantities is possible through the OpenDX (.dx) files, either provided directly from the GIST calculation or output by the gisttools library. 
...
\todo{This figure is missing -vah}
%\begin{figure}
%	\centering
