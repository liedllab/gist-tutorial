...
\begin{table}
	...
	\begin{tabular}{lrrrr}
		System       & E(internal) & $\Delta$E(GIST) & $\Delta$S(GIST) & total \\
		complex      & -1303.4 & -361.2 & -233.1 & -226.7 \\
		streptavidin & -1180.7 & -360.8 & -242.4 & -217.1 \\
		biotin       & -24.0   &  -98.1 &  -35.1 & -161.1 \\
		Diff         & -98.7   &   97.7 &   44.4 &  -45.4
	\end{tabular}
\end{table}
