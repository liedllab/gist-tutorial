...
To use OpenMP or GPU-accelerated (using CUDA) versions of cpptraj, a different executable name such as \inlinecode{cpptraj.OMP} or \inlinecode{cpptraj.cuda} is often used. 
...
Reimage and center the molecule as above, to verify that its position matches the grid parameters you decided on.
...
To investigate such positions, make sure to explicitly place water molecules there. %TODO add MC/MD or mupt and sources
