...
\todo{We could put the examples for how to run GIST, how to visualize a dx file, how to create more dx files, etc., here and move them out. The actual tutorial could be only the streptavidin/biotin thing, and could be shortened a lot if we move the example inputs here.}
