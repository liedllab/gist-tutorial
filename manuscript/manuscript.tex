...
This double counting problem is accounted for by divinding the Eww by a factor of two. 
This is aready taken care of in the current implementation of GIST.
