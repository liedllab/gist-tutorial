...
\begin{figure}
	...
	Blue: negative entropy ($T\Delta S$). Green: negative energy (based on $E_{sw} + 2E_{ww}$). Red: positive energy. 
	Isolevels are ($\pm$) 0.25, 0.5, 1.0, 1.5, 2.0, 2.5, and 3.0 \si{\kcal\per\mole\per\angstrom\squared}, except for the 
	positive energy, where they are divided by 
	two.}\label{fig-binding-pocket.png}
\end{figure}
