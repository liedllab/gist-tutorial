...
\begin{figure}
	...
	to +2.5 kcal/mol/molecule). Blue: low solvent energy (from -3.5 to -2.5 kcal/mol/molecule). The energy density is based on the apo structure and is shown only within \qty{1}{\angstrom} of biotin.}\label{fig_binding_pocket_pymol}
\end{figure}
